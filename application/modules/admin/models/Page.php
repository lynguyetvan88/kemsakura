...
class Admin_Model_Page   {
    ...
    public function add_Page($title, $cat_page, $position, $active, $content, $cat_page_id, $key,$dis)
	{
        ...
        public function update_Page($title, $cat_page, $position, $active, $content,$id, $key,$dis)
	{
    ...
    public function insert_page($menu,$title, $dis, $key, $description, $images,  $position, $active, $content, $home, $price, $price_root)
	{
...
//                 }
    ...
    public function update_Pages($menu,$title, $dis, $key, $description, $images,  $position, $active, $content, $home,$price,$price_root,$id)
	{
