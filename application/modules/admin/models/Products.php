...
class Admin_Model_Products
{
    ...
    public function insert_products(  $title, $description, $images, $content, $menu_id, $price, $state, $sales, $dis, $key, $position, $active, $home, $code, $members,$district_id,$type, $category_id)
        {
        ...
        public function update_products($title, $description, $images, $content, $menu_id, $price, $state, $sales, $dis, $key, $position, $active, $home, $code, $members,$district_id,$type,$category_id,$id)
        {
