        ...
        if (count($this->_arrParam['cart']) > 0) {
            ...
            if (!$this->_request->isPost()) {
                ...
                if ($this->_request->captcha == $captchaWord) {
                    ...
                    $coment = $purifier->purify($this->_request->getParam('content'));
			...
			Nội dung : $coment<br>";
                    ...
                    $mailer->AddCC("lynguyetvan88@gmail.com", 'Lý Lê');
                   // $mailer->AddBCC("sales@rongbienhanquoc.net", 'Rogn biển');
