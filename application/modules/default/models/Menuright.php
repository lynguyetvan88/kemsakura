...
class Default_Model_Menuright  {
      ...
      public function page_1()
        {
         ...
         try {
               ...
               $query="select * from  add_page where cat_page=1  and active=1 and id  in (74) order by position ASC, id ASC ";
         ...
         public function page_2()
        {
         ...
         try {
               $list= $this->page_1();
               $cat_page_id=$list[0]['id'];
               $query="select * from  add_page where cat_page=1 and active=1 and cat_page_id in ($cat_page_id) order by position ASC, id ASC ";
        ...
        public function qc_left()
    {
     ...
     public function cach_thuc_mua_hang()
    {
       
         try {
            
              $query="SELECT * FROM `add_page` where id like '49' ";
