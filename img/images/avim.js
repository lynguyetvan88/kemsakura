...
function AVIM()	{
	...
	if(AVIMGlobalConfig.showControl) {
		...
		document.write('<div class="AVIMControl"><input id="avim_auto" type="radio" name="AVIMMethod" onclick="AVIMObj.setMethod(0);" />Tự động');
		...
		document.write('<input type="checkbox" id="avim_daucu" onclick="AVIMObj.setDauCu(this);" />Kiểu cũ</div>');
		document.write('</span>');
	}
